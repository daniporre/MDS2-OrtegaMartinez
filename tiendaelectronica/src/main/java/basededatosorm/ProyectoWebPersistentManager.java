...
public class ProyectoWebPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoWeb";
	...
	private ProyectoWebPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatosorm.Entregado.class);
		aMetadataSources.addAnnotatedClass(basededatosorm.Usuario.class);
		aMetadataSources.addAnnotatedClass(basededatosorm.Administrador.class);
		aMetadataSources.addAnnotatedClass(basededatosorm.Encargado.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoWebPersistentManager();
		}
