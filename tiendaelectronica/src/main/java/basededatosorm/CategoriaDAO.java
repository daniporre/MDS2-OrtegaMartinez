...
public class CategoriaDAO {
	...
	public static Categoria loadCategoriaByORMID(PersistentSession session, int idCategoria) throws PersistentException {
		try {
			return (Categoria) session.load(basededatosorm.Categoria.class, new Integer(idCategoria));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Categoria getCategoriaByORMID(PersistentSession session, int idCategoria) throws PersistentException {
		try {
			return (Categoria) session.get(basededatosorm.Categoria.class, new Integer(idCategoria));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Categoria loadCategoriaByORMID(PersistentSession session, int idCategoria, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Categoria) session.load(basededatosorm.Categoria.class, new Integer(idCategoria), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Categoria getCategoriaByORMID(PersistentSession session, int idCategoria, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Categoria) session.get(basededatosorm.Categoria.class, new Integer(idCategoria), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryCategoria(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From basededatosorm.Categoria as Categoria");
		if (condition != null)
	...
	public static Categoria createCategoria() {
		return new basededatosorm.Categoria();
	}
	
	public static boolean save(basededatosorm.Categoria categoria) throws PersistentException {
		try {
			basededatosorm.ProyectoWebPersistentManager.instance().saveObject(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatosorm.Categoria categoria) throws PersistentException {
		try {
			basededatosorm.ProyectoWebPersistentManager.instance().deleteObject(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basededatosorm.Categoria categoria)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(basededatosorm.Categoria categoria, org.orm.PersistentSession session)throws PersistentException {
		try {
			basededatosorm.Producto[] lProductoss = categoria.productos.toArray();
			for(int i = 0; i < lProductoss.length; i++) {
				lProductoss[i].categorias.remove(categoria);
	...
	public static boolean refresh(basededatosorm.Categoria categoria) throws PersistentException {
		try {
			basededatosorm.ProyectoWebPersistentManager.instance().getSession().refresh(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatosorm.Categoria categoria) throws PersistentException {
		try {
			basededatosorm.ProyectoWebPersistentManager.instance().getSession().evict(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
