...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-horizontal-layout style="width: 100%; flex-grow: 1; flex-shrink: 1; flex-basis: auto;">
  ...
  <vaadin-vertical-layout class="sidebar" style="flex-basis: calc(7*var(--lumo-size-s)); flex-shrink: 0; background-color: var(--lumo-contrast-5pct);" id="adsVLayout"></vaadin-vertical-layout>
 </vaadin-horizontal-layout>
